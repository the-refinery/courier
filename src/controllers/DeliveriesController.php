...
class DeliveriesController extends Controller
{
    ...
    {
      // CONVERSION: $deliveries = craft()->courier_deliveries->getAllDeliveries([ 'order' => 't.dateCreated DESC' ]);
      // CONVERSION: return $this->renderTemplate('courier/deliveries', compact('deliveries'));
      $variables = [];
      $criteria = Delivery::find()
        ->orderBy("dateCreated DESC");

      // $deliveries = Courier::getInstance()->deliveries->getAllDeliveries([ 'order' => 't.dateCreated DESC' ]);
